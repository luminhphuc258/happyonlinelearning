        ...
        programArray += `
          ...
          <img src="https://readymadeui.com/cardImg.webp" alt="Blog Post 1" class="w-full h-52 object-cover" />
            <div class="p-6">
              ...
              <a href="javascript:void(0);" onclick="show_Modal('${course.program_id}','${course.course_code} ');" class="mt-4 inline-block px-4 py-2 rounded tracking-wider bg-orange-500 hover:bg-orange-600 text-white text-[13px]">Do assignments</a>
            </div>
          </div>
        `;
