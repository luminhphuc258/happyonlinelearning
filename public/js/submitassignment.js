          ...
          <div class="bg-white rounded-2xl p-6">
            ...
            <div class="mt-6">
              <h3 class="text-lg font-bold text-gray-800 mb-3">${course.title}</h3>
                 <p class="text-lg font-bold text-gray-800 mb-3"><span class="text-blue-600">Start From: ${course.semester}</p>
               <p class="text-lg font-bold text-gray-800 mb-3"><span class="text-red-600">To: ${course.description}</p>
                 <h5 class="text-lg font-bold text-gray-800 mb-3">${course.credits} Credits</h5>
                 <p class="text-gray-800 text-sm">${course.description}</p>
              <div class="mt-6">
                <button type="button" onclick="show_Modal('${course.program_id}','${course.course_code} ');"
